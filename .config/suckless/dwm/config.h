...
static const char *volumeplus[] = { "amixer", "sset", "Master", "15%+", NULL };
static const char *volumeminus[] = { "amixer", "sset", "Master", "15%-", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F9,     spawn,          {.v = volumeminus } },
	{ MODKEY,                       XK_F10,    spawn,          {.v = volumeplus } },
	{ MODKEY,                       XK_F12,    spawn,          {.v = volumetoggle } },
